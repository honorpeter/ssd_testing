...
# The database file for training data. Created by data/MELON/create_data.sh
train_data = "examples/MELON/MELON_trainval_lmdb"
# The database file for testing data. Created by data/MELON/create_data.sh
...
# Stores the test image names and sizes. Created by data/MELON/create_list.sh
